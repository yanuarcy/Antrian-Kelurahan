        ...
        <div class="mb-4">
            ...
            <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
              <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">SKT / SKAW</li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="row text-white justify-content-center mt-5 mr-5">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./surat-keterangan-tanah/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../assets/img/SKT.png" style="height: 100px; width: 120px; margin-top: 50px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-tags mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">SURAT<br>KETERANGAN <br>TANAH</div>
                        </div>
                    </div>
                </a>
            </div>
            <!-- Card 2 -->
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./surat-keterangan-ahli-waris/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../assets/img/SKAW.png" style="height: 100px; width: 120px; margin-top: 50px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-tags mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">SURAT<br>KETERANGAN <br>AHLI WARIS</div>
                        </div>
                    </div>
                </a>
            </div>
