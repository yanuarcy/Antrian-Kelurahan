        ...
        <div class="mb-4">
            ...
            <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
              <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">KTP</li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="row text-white justify-content-center mt-5 mr-5">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./pengambilan-ktp/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../../assets/img/Pengambilan_KTP.png" style="height: 100px; width: 110px; margin-top: 25px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-tags mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">PENGAMBILAN<br>KTP</div>
                        </div>
                    </div>
                </a>
            </div>
            <!-- Card 3 -->
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./cetak-ulang-ktp/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../../assets/img/CetakUlang_KTP.png" style="height: 100px; width: 110px; margin-top: 25px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-tags mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">CETAK ULANG<br>KTP</div>
                        </div>
                    </div>
                </a>
            </div>
          ...
          <div class="row text-white justify-content-center mt-5 mr-5">
            ...
            <!-- Card 1 -->
            <!--<div class="col-md-6 col-lg-4 mb-4">-->
            <!--    <a class="text-white" href="./perekaman-ktp/index.php" style="text-decoration: none;">-->
            <!--        <div class="card bg-info h-100 d-flex flex-column">-->
            <!--            <div class="card-body flex-grow-1">-->
            <!--                <div class="card-body-icon">-->
            <!--                    <i class="bi bi-tags mr-2"></i>-->
            <!--                </div>-->
            <!--                <h5 class="card-title">Jenis Layanan</h5>-->
            <!--                <div class="display-6 font-weight-bold">PEREKAMAN<br>KTP</div>-->
            <!--            </div>-->
            <!--        </div>-->
            <!--    </a>-->
            <!--</div>-->
