        ...
        <div class="mb-4">
            ...
            <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
              <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">KIA</li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="row text-white justify-content-center mt-5 mr-5">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./pengambilan-kia/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../../assets/img/Pengambilan_KIA.png" style="height: 100px; width: 100px; margin-top: 45px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-tags mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">PENGAMBILAN<br>KIA</div>
                        </div>
                    </div>
                </a>
            </div>
