        ...
        <div class="mb-4">
          ...
          <div class="row text-white justify-content-center mt-5 mr-5">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./Offline/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../../assets/img/KantorKelurahan.png" style="height: 90px; width: 120px; margin-top: 45px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-tags mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Antrian</h5>
                            <div class="display-6 font-weight-bold">Daftar<br> Di Kelurahan</div>
                        </div>
                    </div>
                </a>
            </div>
            <!-- Card 2 -->
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./Online/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../../assets/img/DaftarOnline.png" style="height: 120px; width: 120px; margin-top: 45px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-tags mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Antrian</h5>
                            <div class="display-6 font-weight-bold">Daftar Online</div>
                        </div>
                    </div>
                </a>
            </div>
