...
if (isset($_POST['register'])) {
    ...
    $jenis_layanan = "SKT/SKAW";
    $keterangan_layanan = "Surat Keterangan Ahli Waris";
      ...
      <div class="row justify-content-lg-center">
        ...
        <div class="form-container">
            ...
            <form class="signUp" action="" method="post">
                ...
                <div class="form-group">
                    <label for="whatsapp">No Whatsapp</label><h6 style="font-weight: bold; color: #FF0000;">*Jika tidak memiliki no whatsapp, silahkan isi " - "</h6>
