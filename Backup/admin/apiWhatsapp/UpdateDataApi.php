<?php
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id']; 
        $data_apiWhatsapp = $lib->get_by_id($id);
        $no_whatsapp = $data_apiWhatsapp['no_whatsapp'];
        $token = $data_apiWhatsapp['token'];
    }
    else
    {
    ...
    if(isset($_POST['submit'])){
        ...
        $token = $_POST['token'];
        $status_update = $lib->update($id, $no_whatsapp, $token);
        if($status_update)
        {
            header('Location: DataApiDisplay.php');
        }
...
<body>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php    
                        ...
                        foreach($data_apiWhatsapp as $row){
                            ...
                            echo "<td class='text-center'><a class='btn btn-warning' href='UpdateDataApi.php?id=".$row['id_api_whatsapp']."'><i class='bi bi-pencil-fill'></i></a>
                            <a class='btn btn-danger' href='DataApiDisplay.php?delete=".$row['id_api_whatsapp']."'><i class='bi bi-trash'></i></a></td>";
                            echo "</tr>";
                            $no++;
                        }
                    ?>
                ...
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h2 class="ModalTittle">Api Whatsapp Data</h2>
                        </div>

                        <div class="modal-body">
                            <form class="input-form" method="POST" role="form">
                                <label for="itemID">Api Whatsapp ID : <?php echo $id ?> </label>
                                <input class="nama" id="nama" name="no_whatsapp" type="text" value="<?php echo $no_whatsapp ?>">
                                <input class="gender" id="gender" name="token" type="text" value="<?php echo $token ?>">
    ...
    <script>
        ...
        span.onclick = function() {
            window.location = "DataApiDisplay.php";
        }
