<?php 
    ...
    if (isset($_POST['register'])) {
        ...
        $alamat = $_POST["alamat"];
        $level = "CS";
        $addMember = new MemberConfig();
        $addMember->createMember($name, $gender, $loket, $email, $username, $password, $telp, $alamat, $level);
        if ($addMember) {
                ...
                <div id="AddModal" class="modalL">
                    ...
                    <div class="modal-contentT">
                        ...
                        <div class="modal-headerR">
                            ...
                            <h2 class="ModalTittle">New Member</h2>
                        </div>
                                    ...
                                    <form class="signUp" action="" method="post">
                                        ...
                                        <div class="formGroup">
                                            ...
                                            <select name="loket" id="loket" required>
                                                <?php
                                                // Generate options for Loket 1-8
                                                for ($i = 1; $i <= 8; $i++) {
                                                    echo "<option value='$i'>Loket $i</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
