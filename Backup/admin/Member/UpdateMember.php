<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $telp = $_POST['telp'];
        $alamat = $_POST['alamat']; 
        $status_update = $lib->update($id,$nama, $gender, $email, $username, $password, $telp, $alamat);
        if($status_update)
        {
            header('Location: MemberDisplay.php');
        }
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
        ...
        <div class="row no-gutters mt-5">
            <div class="col-md-2 bg-dark mt-2 pr-3">
                <div class="bglink">
                    <ul class="nav flex-column ml-3">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="MemberDisplay.php"><i class="bi-people pr-2 pl-1" style="font-size: 27px;"></i>Data Member</a><hr class="bg-secondary">
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-md-10 p-5 pt-2">
                ...
                <a href="#" id="AddBtn" class="btn btn-primary mb-2" style="float: right;"><i class="bi bi-plus-square"></i> Add Member</a>
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php    
                        ...
                        foreach($data_siswa as $row){
                            ...
                            echo "<td class='text-center'><a class='btn btn-warning' href='UpdateMember.php?id=".$row['id_loket']."'><i class='bi bi-pencil-fill'></i></a>
                            <a class='btn btn-danger' href='MemberDisplay.php?delete=".$row['id_loket']."'><i class='bi bi-trash'></i></a></td>";
                            echo "</tr>";
                            $no++;
                        }
                    ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="input-form" method="POST" role="form">
                                ...
                                <input class="nama" id="nama" name="nama" type="text" value="<?php echo $nama ?>">
                                <input class="gender" id="gender" name="gender" type="text" value="<?php echo $gender ?>">
                                <input class="email" id="email" name="email" type="email" value="<?php echo $email ?>">
                                <input class="email" id="email" name="username" type="text" value="<?php echo $username ?>">
                                <input class="password" id="password" name="password" type="text" value="<?php $password ?>">
                                <input class="telp" id="telp" name="telp" type="tel" value="<?php echo $telp ?>">
                                <textarea class="alamat" name="alamat" id="alamat" cols="30" rows="3" value="<?php echo $alamat ?>"></textarea>
