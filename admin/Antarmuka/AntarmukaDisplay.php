<?php 
    ...
    if (isset($_POST['register'])) {
        ...
        $addAntarmuka->createAntarmuka($keterangan, $nama_video, $durasi_video, $alamat_url);
        if ($addAntarmuka) {
...
<head>
    ...
    <title>Admin - AntarmukaDisplay</title>
                ...
                <div id="AddModal" class="modalL">
                    ...
                    <div class="modal-contentT">
                        ...
                        <div class="modal-headerR">
                            ...
                            <h2 class="ModalTittle">New Antarmuka</h2>
                        </div>
                                    ...
                                    <form class="signUp" action="" method="post">
                                        <div class="formGroup">
                                            <select name="keterangan" id="keterangan" required>
                                                <option value="Youtube" selected disabled>Pilih Keterangan</option>
                                                <option value="Youtube">Youtube</option>
                                            </select>
                                        </div>
                                        <div class="formGroup">
                                            <input type="text" id="userName" name="nama_video" placeholder="Nama Video" required>
                                        </div>
                                        <div class="formGroup">
                                            <input type="text" id="userName" name="durasi_video" placeholder="Durasi Video" required>
                                        </div>
                                        <div class="formGroup">
                                            <input type="text" placeholder="Alamat URL" name="alamat_url" required>
                                        </div>
                                        <div class="formGroup">
