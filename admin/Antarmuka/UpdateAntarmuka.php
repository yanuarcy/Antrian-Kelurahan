<?php
    ...
    $lib = new AntarmukaConfig();
    if(isset($_GET['id'])){
        $id = $_GET['id']; 
        $data_antarmuka = $lib->get_by_id($id);
        $keterangan = $data_antarmuka['keterangan'];
        $nama_video = $data_antarmuka['nama'];
        $durasi_video = $data_antarmuka['durasi_video'];
        $sumber = $data_antarmuka['sumber'];
    }
    else
    {
    ...
    if(isset($_POST['submit'])){
        ...
        $sumber = $_POST['sumber'];
        $status_update = $lib->update($id, $nama_video, $durasi_video, $keterangan, $sumber);
        if($status_update)
        {
            header('Location: AntarmukaDisplay.php');
        }
...
<body>
        ...
        <div class="row no-gutters mt-5">
            <div class="col-md-2 bg-dark mt-2 pr-3">
                ...
                <ul class="nav flex-column ml-3">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" href="AntarmukaDisplay.php"><i class="bi bi-tv pr-3" style="font-size: 27px;"></i>Data Antarmuka</a><hr class="bg-secondary">
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-10 p-5 pt-2">
                ...
                <a href="#" id="AddBtn" class="btn btn-primary mb-2" style="float: right;"><i class="bi bi-plus-square"></i> Add Antarmuka</a>
                    ...
                    <?php    
                        if(isset($_POST['cari'])){
                            ...
                            foreach($data_search as $row){
                                $video_embed = htmlspecialchars($row['sumber']);
                                ...
                                echo "<td>" . htmlspecialchars($row['durasi_video']) . "</td>";
                                ...
                                echo "<td class='text-center'>
                                <button class='btn btn-success activate-video' data-id='" . htmlspecialchars($row['id_antarmuka']) . "' data-status='1'>
                                    <i class='bi bi-check-circle-fill'></i>
                                </button>
                                <a class='btn btn-warning' href='UpdateAntarmuka.php?id=" . htmlspecialchars($row['id_antarmuka']) . "'>
                                    <i class='bi bi-pencil-fill'></i>
                                </a>
                                <a class='btn btn-danger' href='AntarmukaDisplay.php?delete=" . htmlspecialchars($row['id_antarmuka']) . "'>
                ...
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h2 class="ModalTittle">Antarmuka Data</h2>
                        </div>

                        <div class="modal-body">
                            <form class="input-form" method="POST" role="form">
                                <label for="itemID">Antarmuka ID : <?php echo $id ?> </label>
                                <input class="gender" id="gender" name="keterangan" type="text" value="<?php echo $keterangan ?>">
                                <input class="nama" id="nama" name="nama_video" type="text" value="<?php echo $nama_video ?>">
                                <input class="nama" id="nama" name="durasi_video" type="text" value="<?php echo $durasi_video ?>">
                                <input class="email" id="email" name="sumber" type="text" value="<?php echo $sumber ?>">
    ...
    <script>
        ...
        span.onclick = function() {
            window.location = "AntarmukaDisplay.php";
        }
