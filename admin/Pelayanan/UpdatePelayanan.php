<?php
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id']; 
        $data_pelayanan = $lib->get_by_id($id);
        $kode_antrian = $data_pelayanan['Kode_Antrian'];
        $jenis = $data_pelayanan['Jenis'];
        $keterangan = $data_pelayanan['Keterangan'];
    }
    else
    {
        header('Location: PelayananDisplay.php');
    }
    ...
    if(isset($_POST['submit'])){
        ...
        $status_update = $lib->update($id, $kode_antrian, $jenis, $keterangan);
        if($status_update)
        {
            header('Location: PelayananDisplay.php');
        }
...
<body>
                ...
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h2 class="ModalTittle">Pelayanan Data</h2>
                        </div>

                        <div class="modal-body">
                            <form class="input-form" method="POST" role="form">
                                <label for="itemID">Pelayanan ID : <?php echo $id ?> </label>
                                <input class="nama" id="nama" name="kode_antrian" type="text" value="<?php echo $kode_antrian ?>">
                                <input class="gender" id="gender" name="jenis" type="text" value="<?php echo $jenis ?>">
                                <input class="email" id="email" name="keterangan" type="text" value="<?php echo $keterangan ?>">
    ...
    <script>
        ...
        span.onclick = function() {
            window.location = "PelayananDisplay.php";
        }
