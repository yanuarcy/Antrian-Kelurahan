...
if (isset($_POST['register'])) {
    ...
    $keterangan_layanan = "Pengambilan KIA";
            ...
            <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
              <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href="../index.php" style="text-decoration: none; color: #00aa9d">KIA</a></li>
                  <li class="breadcrumb-item" aria-current="page">PENGAMBILAN KIA</li>
                </ol>
              </nav>
            </div>
          </div>
