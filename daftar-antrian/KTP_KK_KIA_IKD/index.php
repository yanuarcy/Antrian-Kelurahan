        ...
        <div class="mb-4">
          ...
          <div class="row text-white justify-content-center mt-5 mr-5">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./KTP/index.php" style="text-decoration: none;">
                  <div class="card bg-info h-100 d-flex flex-column">
                        <!-- <img src="../../assets/img/KTP_Animasi.png" style="height: 100px; width: 100px;" class="card-img-top" alt="KTP Image"> -->
                        <!-- <img src="/assets/img/KTP_Animasi.png" class="card-img-top" alt="KTP Image"> -->
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../assets/img/KTP_Animasi.png" style="height: 130px; width: 130px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-person-badge mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">KTP</div>
                        </div>
                    </div>
                </a>
            </div>
            <!-- Card 2 -->
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./KK/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../assets/img/KK_Animasi.png" style="height: 90px; width: 130px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-people mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">KK</div>
                        </div>
                    </div>
                </a>
            </div>
          ...
          <div class="row text-white justify-content-center mt-5 mr-5">
            <!-- Card 3 -->
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./KIA/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../assets/img/KIA_Animasi.png" style="height: 80px; width: 130px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-person-badge-fill mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">KIA</div>
                        </div>
                    </div>
                </a>
            </div>
            <!-- Card 4 -->
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./IKD/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../assets/img/IKD_Animasi.png" style="height: 90px; width: 120px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-file-earmark-text mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">IKD</div>
                        </div>
                    </div>
                </a>
            </div>
