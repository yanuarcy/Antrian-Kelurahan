        ...
        <div class="mb-4">
            ...
            <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
              <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">AKTA</li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="row text-white justify-content-center mt-5 mr-5">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./AKTA-KELAHIRAN/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../assets/img/Akta_Kelahiran.png" style="height: 120px; width: 120px; margin-top: 30px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-tags mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">AKTA<br>KELAHIRAN</div>
                        </div>
                    </div>
                </a>
            </div>
            <!-- Card 2 -->
            <div class="col-md-6 col-lg-4 mb-4">
                <a class="text-white" href="./AKTA-KEMATIAN/index.php" style="text-decoration: none;">
                    <div class="card bg-info h-100 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <div class="card-body-icon">
                                <img src="../../assets/img/Akta_Kematian.png" style="height: 135px; width: 165px; margin-top: 25px;" class="card-img-top" alt="KTP Image">
                                <!-- <i class="bi bi-tags mr-2"></i> -->
                            </div>
                            <h5 class="card-title">Jenis Layanan</h5>
                            <div class="display-6 font-weight-bold">AKTA<br>KEMATIAN</div>
                        </div>
                    </div>
                </a>
            </div>
